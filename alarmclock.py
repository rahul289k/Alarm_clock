...
#Importing libraries to be used alarm clock:
from tkinter import *
import datetime
import time
import winsound
...
secTime = Entry(clock,textvariable = sec,bg = "red",width = 15).place(x=200,y=30)

#To take the time input by user:
submit = Button(clock,text = "Set Alarm",fg="red",width = 10,command = alarm_time).place(x =110,y=70)
